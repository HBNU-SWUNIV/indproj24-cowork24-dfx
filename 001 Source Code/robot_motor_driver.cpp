#include "../../include/Robot/Robot_motor_driver.h"

RobotMotorDriver::RobotMotorDriver()
: baudrate_(BAUDRATE),
...
{
  torque_ = false;
  dynamixel_limit_max_velocity_ = robot_DXL_LIMIT_MAX_VELOCITY;
}
...
bool RobotMotorDriver::init(String Robot)
{
...
bool RobotMotorDriver::setTorque(bool onoff)
{
  uint8_t dxl_error = 0;
...
bool RobotMotorDriver::getTorque()
{
  return torque_;
}

void RobotMotorDriver::close(void)
{
...
bool RobotMotorDriver::readEncoder(int32_t &left_value, int32_t &right_value)
{
...
bool RobotMotorDriver::writeVelocity(int64_t left_value, int64_t right_value)
{
...
bool RobotMotorDriver::controlMotor(const float wheel_radius, const float wheel_separation, float* value)
{
