#include "../../include/Robot/Robot_diagnosis.h"

RobotDiagnosis::RobotDiagnosis()
{
}
...
void RobotDiagnosis::showLedStatus(bool isConnected)
{
...
void RobotDiagnosis::updateRxTxLed(void)
{
...
void RobotDiagnosis::setPowerOn(void)
{
  digitalWrite(BDPIN_DXL_PWR_EN, HIGH);
}

void RobotDiagnosis::setPowerOff(void)
{
  digitalWrite(BDPIN_DXL_PWR_EN, LOW);
}

uint8_t RobotDiagnosis::updateVoltageCheck(bool check_setup)
{  
...
uint8_t RobotDiagnosis::getButtonPress(uint16_t time_to_press)
{
